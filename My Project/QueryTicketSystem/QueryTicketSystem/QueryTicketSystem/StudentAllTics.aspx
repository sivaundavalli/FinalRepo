<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Home.Master" CodeBehind="StudentAllTics.aspx.cs" Inherits="QueryTicketSystem.StudentAllTics" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="User_ContentPlaceHolder" runat="server">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
     <div class="clsDivInContent">   
         ...
         <div style="padding-left:390px;padding-top:30px">
        <div class="clsDivStudTic" style="width:65%;height:480px;">
           ...
           <%-- <div align="left" style="padding-right:10px">
            ...
            <div class="clsdivGrid" style="width:99%;height:420px;">
                <asp:UpdatePanel ID="UP_MyTics" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvTics" runat="server" AutoGenerateColumns="False" Width="100%" Height="100%" EmptyDataText="No Records Found" DataSourceID="ODS_AllTics"
                             CssClass="Grid"                    
                      AlternatingRowStyle-CssClass="alt"
                      PagerStyle-CssClass="pgr" AllowPaging="True" OnPageIndexChanging="gvTics_PageIndexChanging" OnRowDataBound="gvTics_RowDataBound" PageSize="20">
                            <AlternatingRowStyle CssClass="alt" />
                            <Columns>
         ...
         <asp:ObjectDataSource ID="ODS_AllTics" runat="server" SelectMethod="GetAllTickets" TypeName="QueryTicketSystem.Classes.BusinessObjects"></asp:ObjectDataSource>
    </div>
