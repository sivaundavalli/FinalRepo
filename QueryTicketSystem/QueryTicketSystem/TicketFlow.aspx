    ...
    <form id="form1" runat="server">
        ...
        <div>
            <div style="text-align: right; font-weight: bold; color: red; padding-top: 5px; padding-right: 5px;">
                Logged In User: 
                <asp:Label ID="lblLoggedID" runat="server" Text="" ForeColor="Green"></asp:Label>
            </div>
            <div style="padding-left: 20px; padding-top: 30px;">
                <table style="font-weight: bold; font-size: 18px; color: #990000">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblViewStatus" runat="server" Text="View Status:"></asp:Label>
                          
                           
                            </td>
                        <td>  
                            <asp:DropDownList runat="server" ID="ddlTicViewStatus" CssClass="clsddl">
                                <asp:ListItem Value="Select">Select</asp:ListItem>
                                <asp:ListItem Value="Pulic">Public</asp:ListItem>
                                <asp:ListItem Value="Private">Private</asp:ListItem>
                            </asp:DropDownList>
                            <asp:Label ID="lblVS" runat="server" Text=""></asp:Label>
                              &nbsp;&nbsp;
                    
                            <asp:LinkButton ID="lnkSave1" runat="server" Font-Underline="True" Font-Bold="False" ForeColor="#3333FF" OnClick="lnkSave1_Click" CausesValidation="False"></asp:LinkButton>
                             <%--<asp:HyperLink ID="lnkSave1" runat="server" Font-Underline="True" Font-Bold="False" ForeColor="#3333FF"></asp:HyperLink>--%>
                             </td>
                    </tr>
                    <tr>
                        <td>
                             <asp:Label ID="lblSubType" runat="server" Text="Subject Type:"></asp:Label>
                            
                        </td>
                        <td>
                            <asp:DropDownList runat="server" ID="ddlSubType" CssClass="clsddl">
                                <asp:ListItem Value="Select">Select</asp:ListItem>
                                <asp:ListItem Value="Subject">Subject</asp:ListItem>
                                <asp:ListItem Value="Non-Subject">Non-Subject</asp:ListItem>
                            </asp:DropDownList>
                              <asp:Label ID="lblST" runat="server" Text=""></asp:Label>
                             &nbsp;&nbsp;
                    
                         <asp:LinkButton ID="lnkSave2" runat="server" Font-Underline="True" Font-Bold="False" ForeColor="#3333FF" OnClick="lnkSave2_Click" CausesValidation="False"></asp:LinkButton>
                            <%--<asp:HyperLink ID="lnkSave2" runat="server" Font-Underline="True" Font-Bold="False" ForeColor="#3333FF"></asp:HyperLink>--%>
                        </td>
                    </tr>
                </table>
            </div>
